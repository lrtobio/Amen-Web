					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Favorite'), array('action' => 'add'), array('escape' => false)); ?></li>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('mobile_user_id'); ?></th>
						<th><?php echo $this->Paginator->sort('type_id'); ?></th>
						<th><?php echo $this->Paginator->sort('favorite_id'); ?></th>
				...
				<?php foreach ($favorites as $favorite): ?>
					<tr>
						<td><?php echo h($favorite['Favorite']['id']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($favorite['MobileUser']['nombre'], array('controller' => 'mobile_users', 'action' => 'view', $favorite['MobileUser']['id'])); ?>
		</td>
						<td><?php echo h($favorite['Favorite']['type_id']); ?>&nbsp;</td>
						<td><?php echo h($favorite['Favorite']['favorite_id']); ?>&nbsp;</td>
						<td><?php echo h($favorite['Favorite']['created']); ?>&nbsp;</td>
						<td><?php echo h($favorite['Favorite']['titulo']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $favorite['Favorite']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $favorite['Favorite']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $favorite['Favorite']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $favorite['Favorite']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
